function [MyLat]=SingleCellAuxetic(H,L,h,dx,dy,dz)
...
MyLat.Cells(5).P=[22 14; 22 18; 23 18; 22 19; 25 19; 26 19; 26 18];
...
for n2=1:8
for n1=1:7
    MyLat.Cells(n2).L(n1).X=[MyLat.Nodes(MyLat.Cells(n2).P(n1,1),1) ...
        MyLat.Nodes(MyLat.Cells(n2).P(n1,2),1)];
    MyLat.Cells(n2).L(n1).Y=[MyLat.Nodes(MyLat.Cells(n2).P(n1,1),2) ...
        MyLat.Nodes(MyLat.Cells(n2).P(n1,2),2)];
    MyLat.Cells(n2).L(n1).Z=[MyLat.Nodes(MyLat.Cells(n2).P(n1,1),3) ...
